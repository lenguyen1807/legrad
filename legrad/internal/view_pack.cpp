...
void view_pack::resize_storage(Size new_dim)
{
  const Size old_dim = dim_;
...
void view_pack::move_out_to_inline_storage(Size new_dim, Size old_dim)
{
...
void view_pack::move_inline_to_out_storage(Size new_dim, Size old_dim)
{
...
void view_pack::resize_out_of_line_storage(Size new_dim, Size old_dim)
{
...
Int* view_pack::allocate_new_storage(Size n)
{
...
void view_pack::reallocate_out_of_line_storage(Size n)
{
